...
//           darkMode: session.user.preferences.theme === 'dark'
//         })
//       }
//     }
//   }, [session])
...
//       // Refresh the page to ensure session is still valid after password change
//       window.location.reload()
//     } catch (error: any) {
...
//                 />
//                 <p id="name-help" className="text-xs text-muted-foreground">Enter your full name</p>
//               </div>
//               <div className="space-y-2">
...
//                 />
//                 <p id="email-help" className="text-xs text-muted-foreground">Enter your email address</p>
//               </div>
//               <Button
...
//                   </div>
//                   <p id="notifications-help" className="text-sm text-muted-foreground mt-1">Receive email notifications</p>
//                 </div>
//                 <Switch
//                   id="notifications"
...
//                   </div>
//                   <p id="dark-mode-help" className="text-sm text-muted-foreground mt-1">Use dark theme</p>
//                 </div>
//                 <Switch
//                   id="dark-mode"
...
//                   <Button variant="outline" size="sm" className="w-8 h-8 rounded-full bg-blue-500 hover:bg-blue-600" />
//                   <Button variant="outline" size="sm" className="w-8 h-8 rounded-full bg-purple-500 hover:bg-purple-600" />
//                   <Button variant="outline" size="sm" className="w-8 h-8 rounded-full bg-green-500 hover:bg-green-600" />
//                   <Button variant="outline" size="sm" className="w-8 h-8 rounded-full bg-red-500 hover:bg-red-600" />
//                 </div>
//               </div>
//               <Button
...
//                 />
//                 <p id="current-password-help" className="text-xs text-muted-foreground">Enter your current password</p>
//               </div>
//               <div className="space-y-2">
...
//                 />
//                 <p id="new-password-help" className="text-xs text-muted-foreground">Enter your new password</p>
//               </div>
//               <div className="space-y-2">
...
//                 />
//                 <p id="confirm-password-help" className="text-xs text-muted-foreground">Confirm your new password</p>
//               </div>
//               <Button
...
//                 <p id="delete-account-help" className="text-sm text-muted-foreground">Permanently remove your account and all data</p>
//                 <Button
//                   variant="destructive"
